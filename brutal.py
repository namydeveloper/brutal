...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa Subscribe Channel Namydev")
time.sleep(3)
os.system("xdg-open https://youtube.com/c/Namydevo")
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Namydev
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Namydev
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : Namydev
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @Namydev
